"""
 This script is part of a study-project by TU-Dresden
  ...
  This script compares different number of stress periods where one argument will be needed
...
dis = mf.ModflowDis(ml, nlay=NLay, nrow=N, ncol=N, delr=delRow, delc=delCol, top=0.0, botm=bot, laycbd=0, lenuni=2, itmuni=4, steady=steady, nper=nPer, perlen=int(sys.argv[1]))
