...
print 'Running ' + sys.argv[0] + ' ' + sys.argv[1] + sys.argv[2]
...
# setting up wells data and well package
nwells=int(sys.argv[1])
p_rate = int(sys.argv[2]) # m^3 / year
...
wel = mf.ModflowWel(ml, stress_period_data=lrcq)
